...
window.AAIF_TAXONOMY = [
  ...
  },
  {
    ...
    aliases: [],
    broaderTerm: null,
    definition: 'Low-quality, often erroneous or nonsensical content generated by artificial intelligence models.',
    scopeNote: 'Refers to outputs that lack coherence, accuracy, or utility, typically resulting from inadequate training data, model limitations, or over-reliance on generative AI without human oversight.',
    relatedTerms: [],
    contrastsWith: [],
    workgroups: []
  }
